...
\begin{document}
\thispagestyle{empty}
\input{resume_spr2-concordance}


\begin{multicols}{2}
{\Large {\bf Jeremy Springman, PhD}}\\
Research Scientist, Demography \& Survey Science\\
Meta\\
%Updated \today \\
...
\faEnvelope: \href{mailto:jeremyrgs6@gmail.com}{jeremyrgs6@gmail.com}\\
...
Research scientist with expertise in AI, causal inference, and data-driven product development:
\begin{itemize}[itemsep=0mm, parsep=0pt]
\item 10+ years of quantitative research experience (LLMs, causal inference, ML, survey methodology) in industry, policy, and academia
\item End-to-end builder; designed and shipped production data pipelines and agentic AI analytics platforms
\item Experienced team lead and technical mentor; track record of delivering for stakeholders and communicating insights to senior leadership
\end{itemize}

\textbf{\large Work Experience}\\
\rule[3mm]{\textwidth}{.2pt}
\noindent\begin{tabular*}{\textwidth}{@{}l@{\extracolsep{\fill}}r@{}}
\textbf{Meta}, Research Scientist and AI Captain & July 2025 -- Present\\
\end{tabular*}
\begin{itemize}[itemsep=0mm, parsep=0pt]
  \item Built team-wide AI tools, including AI insights platform with custom MCP, agents, and ETL pipelines
  \item Appointed ``AI Captain'': co-designed and led AI training for 50 PhD researchers and senior leadership (VP-level); every participant built and shipped functional tools
  \item Lead competitive intelligence on LLM enterprise adoption, surfacing strategic insights for leadership
\end{itemize}

\noindent\begin{tabular*}{\textwidth}{@{}l@{\extracolsep{\fill}}r@{}}
\textbf{University of Pennsylvania, \href{https://web.sas.upenn.edu/dev-lab/}{PDRI-DevLab}}\\
Non-Resident Scholar & July 2025 -- Present\\
Director of Research: Research Assistant Professor & July 2024 -- July 2025\\
...
\begin{itemize}[itemsep=0mm, parsep=0pt]
  ...
  \item Introduced \href{https://web.sas.upenn.edu/mlp-devlab/civic-space-data-and-forecasts/}{early warning system} used by 800 stakeholders to guide crisis response
  ...
  \item Produced 7 \href{https://jrspringman.github.io/research.html#select-commissioned-policy-reports}{commissioned policy reports} and published 2 \href{https://jrspringman.github.io/research.html#under-review}{manuscripts} in peer-reviewed journals
