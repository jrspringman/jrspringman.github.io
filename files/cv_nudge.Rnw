...
I am an applied researcher working to design, implement, and evaluate behavioral science solutions to complex social problems. I have deep experience leading large-scale RCT-evaluations and managing interdisciplinary research teams, establishing long-term collaborations with public and private sector partners, communicating technical material to policy audiences, and evaluating behavioral interventions across diverse subject-matters and contexts. I have six years of experience managing a team of 12 researchers and staff in a lab environment and 10 years of experience with survey and experimental research, network analysis, and machine learning. Since 2022, I have won nearly \$3.5 million as PI or co-PI on both federal and private research grants.
