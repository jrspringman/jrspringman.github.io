...
I am an applied researcher passionate about bringing advanced experimentation methodologies to real-world decision-making. As a Research Assistant Professor running major research projects in a social science research lab, I have deep experience with both data science and data governance

MLP is a major repository of high-quality online news
- determining data access policies for permanent project staff, temporary undergraduate and graduate research fellows, and faculty affiliates outside our university
- policies for collaboration and data sharing, often requiring consultation with university lawyers on IP law
- ethical review for data access for 
...
Haus is an ideal fit for several reasons. Having followed Reddit as an active user for years, I am enthusiastic about contributing to the platform’s growth and evolution. As the social media ecosystem becomes more fractured, Haus’s unique role as a community-driven platform make it a critical online space. The potential to make a tangible impact on millions of users worldwide is an opportunity that I would be honored to embrace. 
In summary, I highly qualified and extremely excited to accelerate growth through cutting-edge experimentation, refine key metrics to empower product teams, and advance novel techniques within Haus’s product offerings. Thank you for considering my application.
