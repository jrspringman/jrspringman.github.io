...
I am a Research Professor eager to apply my expertise in research design, data analysis, and scientific communication to help Grow Progress clients make breakthroughs in persuasion. I have 10 years of experience with statistical computing (R, Python, git, markdown, shiny), strong knowledge of causal inference and machine learning, six years of experience managing relationships with donors and communicating research findings to non-technical policy audiences, and deep familiarity with online survey platforms, including designing, programming, and analyzing complex survey experiments in Qualtrics.
...
\item Secured funding for policy research
\item Designed and analyzed commissioned RCTs and survey experiments
\item Presented findings to donors and policymakers
