...
<p><strong>Pushing Back or Backing Down? Examining Donor Response to Restrictive NGO Legislation</strong><br />
with Lucy Right and Erik Wibbels<br />
Conditionally Accepted, *International Organization*<br />
[[paper and appendix](/files/The_Effect_of_NGO_Laws_on_Bilateral_Aid_Flows.pdf){target="_blank"}]</p>
::: {.grid  }
::: {.g-col-8}
...
with Braeden Davis, David Dow, and Juan Tellez<br/>
Revise & Resubmit, *Journal of Conflict Resolution*<br />

[[paper](/files/ethiopia_experiments.pdf){target="_blank"}][[appendix](/files/ethiopia_experiments_appendix.pdf){target="_blank"}]</p>
::: {.grid  }
::: {.g-col-8}
